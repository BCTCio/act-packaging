...
class ControllerCommonNewsletter extends Controller {
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $category_id) {
                $this->model_common_newsletter->deleteNewsletter($category_id);
            }

            $this->session->data['success'] = 'Success: You have modified newsletter! ';
	...
	protected function getList() {
		...
		$data['delete'] = $this->url->link('common/newsletter/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
