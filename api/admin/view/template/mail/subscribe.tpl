                                                ...
                                                <td valign='top' align='center'>
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable">
                                                            <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><img src="http://jiaherb.yourwebhosting.com/img/logo.png"></p>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td align='center' bgcolor='#69C374' style='background:#69C374; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <a target='_blank' href='<?php echo $link_url; ?>' class='link2' style='color:#ffffff;'>Click button to view details</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                                                            <span style='font-weight:bold;'>Jiaherb Inc.</span>
                                                                            <br>
                                                                            www.jiaherbinc.com
                                                                            <br>
                                                                        </p>
