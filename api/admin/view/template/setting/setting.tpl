          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
                ...
                <div class="form-group required" style="display: none;">
                    <label class="col-sm-2 control-label" for="input-voucher-min">Delivery Min</label>
                    <div class="col-sm-10">
                        <input type="text" name="config_voucher_min" value="<?php echo $config_voucher_min; ?>" placeholder="Delivery Min" id="input-voucher-min" class="form-control" />
                        <?php if ($error_voucher_min) { ?>
                        <div class="text-danger">Minimum delivery amount required!</div>
                        <?php } ?>
                    </div>
                </div>
                <div class="form-group required">
