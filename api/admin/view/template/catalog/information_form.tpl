                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-status">Category</label>
                        <div class="col-sm-10">
                            <select name="category" id="input-category" class="form-control">
                                <option value="0">--</option>
                                <option value="1" <?php if ($category == 1) { ?>selected="selected"<?php } ?>>Company News</option>
                                <option value="2" <?php if ($category == 2) { ?>selected="selected"<?php } ?>>Printing Industry</option>
                                <option value="3" <?php if ($category == 3) { ?>selected="selected"<?php } ?>>Machine</option>
                                <option value="4" <?php if ($category == 4) { ?>selected="selected"<?php } ?>>Eco-friendly</option>
                                <option value="5" <?php if ($category == 5) { ?>selected="selected"<?php } ?>>Packaging</option>
                                <option value="6" <?php if ($category == 6) { ?>selected="selected"<?php } ?>>Exhibition</option>
                            </select>
                        </div>
                    </div>
                  <div class="form-group required">
